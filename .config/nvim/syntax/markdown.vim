...
syn region mathCode1 start=+\$+ skip=+\\\$+ end=+\$+ keepend contains=@latexmathCode
syn region mathCode2 start=+\$\$+ skip=+\\\$+ end=+\$\$+ keepend contains=@latexmathCode
syn region mathCode3 start=+\\begin{equation}+ end=+\\end{equation}+ keepend contains=@latexmathCode
syn region yamlCode start=+---+ end=+---\|\.\.\.$+ keepend contains=@yamlCode

syn include @latexmathCode syntax/tex.vim
unlet b:current_syntax
syn include @yamlCode syntax/yaml.vim
unlet b:current_syntax
