;; my-molokai-theme.el --- inspired by Textmate's monokai
(require 'doom-themes)

;;
(defgroup my-molokai-theme nil
  "Options for my-molokai."
  :group 'doom-themes)

(defcustom my-molokai-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'my-molokai-theme
  :type 'boolean)

(defcustom my-molokai-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme my-molokai
  ...
  ((bg         '("#1c1e1f" nil       nil          ))
   ...
   (selection      base5)
   (builtin        orange)
   (comments       (if my-molokai-brighter-comments violet base5))
   (doc-comments   (if my-molokai-brighter-comments (doom-lighten violet 0.1) (doom-lighten base5 0.25)))
   (constants      orange)
   (functions      green)
   (keywords       magenta)
   (methods        cyan)
   ...
   ;; custom categories
   (-modeline-pad
    (when my-molokai-padded-modeline
      (if (integerp my-molokai-padded-modeline)
          my-molokai-padded-modeline
        4)))
